...
const initialProducts = [
    { id: 1, name: 'Paracetamol 500mg', sku: 'P001', price: 50000, stock: 120, category: 'Pain Relievers', description: 'Effective for fever and mild pain.' },
    { id: 2, name: 'Amoxicillin 250mg', sku: 'A002', price: 125000, stock: 5, category: 'Antibiotics', description: 'Broad-spectrum antibiotic.' },
    { id: 3, name: 'Vitamin C 1000mg', sku: 'V003', price: 80000, stock: 45, category: 'Supplements', description: 'Boosts immune system.' },
    { id: 4, name: 'Ibuprofen 400mg', sku: 'I004', price: 65000, stock: 2, category: 'Pain Relievers', description: 'Anti-inflammatory drug.' },
    { id: 5, name: 'Cetirizine 10mg', sku: 'C005', price: 42000, stock: 80, category: 'Allergy', description: 'Relieves allergy symptoms.' },
];
...
const initialInventory = initialProducts.map(p => ({
    ...
    status: p.stock === 0 ? 'Hết hàng' : p.stock < 10 ? 'Sắp hết hàng' : 'Còn hàng'
}));

const initialCustomers = [
    { id: 1, name: 'Nguyen Van A', phone: '0901234567', points: 120, lastPurchase: '2023-10-25', totalSpend: 4500000 },
    { id: 2, name: 'Tran Thi B', phone: '0912345678', points: 340, lastPurchase: '2023-10-22', totalSpend: 12000000 },
    { id: 3, name: 'Le Van C', phone: '0987654321', points: 50, lastPurchase: '2023-10-15', totalSpend: 1200000 },
];
...
const initialLogs = [
    { id: 1, action: 'Thêm sản phẩm', target: 'Paracetamol 500mg', user: 'Admin User', date: '2023-10-26 10:30', details: 'Added new SKU P001' },
];
...
const initialOrders = [
    {
        ...
        itemsList: [
            { id: 1, name: 'Paracetamol 500mg', quantity: 2, price: 500000 },
            { id: 3, name: 'Vitamin C 1000mg', quantity: 1, price: 500000 }
        ]
    },
    {
        id: 102,
        ...
        itemsList: [
            { id: 2, name: 'Amoxicillin 250mg', quantity: 10, price: 125000 },
            { id: 5, name: 'Cetirizine 10mg', quantity: 20, price: 57500 }
        ]
    },
    {
        id: 103,
        ...
        itemsList: [
            { id: 1, name: 'Paracetamol 500mg', quantity: 17, price: 50000 }
        ]
    }
];
...
export const mockApi = {
    ...
    addProduct: async (product, username) => {
        ...
        db.inventory.push({
            ...
            status: parseInt(newProduct.stock) === 0 ? 'Hết hàng' : parseInt(newProduct.stock) < 10 ? 'Sắp hết hàng' : 'Còn hàng'
        });
        ...
        db.logs.unshift({
            ...
            details: `Thêm sản phẩm mới ${newProduct.sku} với giá ${newProduct.price} VNĐ`
        });
    ...
    updateProduct: async (id, updates, username) => {
        ...
        if (index !== -1) {
            ...
            if (updates.price && parseFloat(updates.price) !== oldProduct.price) changes.push(`giá (${oldProduct.price} -> ${updates.price}) VNĐ`);
    ...
    addEmployee: async (employee, adminUsername) => {
        await delay();
        const newEmployee = { ...employee, id: Date.now(), status: 'Active' };
        db.employees.push(newEmployee);

        // Add to users db to allow login
    ...
    login: async (identifier, password) => {
        await delay(800);
        // Simulating specific credentials for roles (support both username and email)
        const isAdmin = identifier === 'admin' || identifier === 'admin@gmail.com';
        const isStaff = identifier === 'staff' || identifier === 'staff@gmail.com';
        const isUser = identifier === 'user' || identifier === 'user@gmail.com';

        if (isAdmin && password === '123') {
            return { id: 1, name: 'Admin User', role: 'Admin', token: 'mock-jwt-admin', email: 'admin@gmail.com' };
        }
        if (isStaff && password === '123') {
            return { id: 2, name: 'Staff User', role: 'Staff', token: 'mock-jwt-staff', email: 'staff@gmail.com' };
        }
        if (isUser && password === '123') {
            return { id: 3, name: 'Regular User', role: 'User', token: 'mock-jwt-user', email: 'user@gmail.com' };
        }
...
// Alias for use in AuthContext
export const adminMockApi = mockApi;